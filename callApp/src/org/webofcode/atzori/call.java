...
public class call extends FunctionBase {
    ...
    public void checkBuild(String uri, ExprList args) { 
        if ( args.size() < 1 )
            throw new QueryBuildException("Function takes at least one argument") ;
    }
    ...
    public NodeValue exec(List<NodeValue> args)
    {
        if ( args == null )
            ...
            throw new ARQInternalErrorException("Function Null args list") ;
        
        if ( args.size() < 1 )
            throw new ExprEvalException("Function takes at least one argument") ;
